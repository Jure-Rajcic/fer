...
public class ArrayIndexedCollection implements List {
    ...
    private static class ArrayIndexedElementGetter implements ElementsGetter {
        private ArrayIndexedCollection collection;
        private int index;
        private long savedModificationCount;

        private ArrayIndexedElementGetter(ArrayIndexedCollection collection) {
    ...
    public ElementsGetter createElementsGetter() {
        return new ArrayIndexedElementGetter(this);
    }
    ...
    public void addAllSatisfying(Collection col, Tester tester){
        ...
        class LocalProces implements Processor {
            ...
            public void process(Object value) {
                ...
                ArrayIndexedCollection.this.add(value);
            }
        }
